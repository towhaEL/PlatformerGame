...
lbar_img = pygame.image.load('img/Lbar.png')
rbar_img = pygame.image.load('img/Rbar.png')
lend_img = pygame.image.load('img/Ground_10.png')
rend_img = pygame.image.load('img/Ground_12.png')
...
for tile in range(0, 20):
	...
	world_data[tile][19] = 111
	world_data[19][0] = 12
	world_data[19][19] = 112
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 9:
					#spike
					img = pygame.transform.scale(spike_img, (tile_size, int(tile_size * 1.5)))
					screen.blit(img, (col * tile_size, row * tile_size - (tile_size // 2)))
